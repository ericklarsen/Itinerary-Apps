...
class index extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      dataForm3_eating: [{ id_lunch: '0', id_dinner: '0', day_it_eating: '1' }],
  ...
  toNext = (data) => {
    ...
    if (!this.state.dataSelected2 && !this.state.dataSelected3) {
      value = [{ id_lunch: '0', id_dinner: '0', day_it_eating: '1' }];

      if (this.state.dataForm3_day.length > 0) {
        this.props.navigation.navigate('form3_1', {
          dataForm2: data,
      ...
      if (this.state.dataForm3_day.length > 0) {
        this.props.navigation.navigate('form3_1', {
          ...
          dataForm3_dinner_temp: this.state.dataForm3_dinner,
          dataForm3_total_temp: this.state.dataForm3_total,
          dataForm3_eating_temp: this.state.dataForm3_eating,
          dataSource: this.arrayHolder,
          dataSelected: this.state.dataSelected,
          day: parseInt(this.state.day) + 1
        });
  ...
  //   console.log(this.state.dataForm3_day.length)
      ...
      return (
        this.state.dataSelected3.map((Object, index) => (
          ...
          <View key={index} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 }}>
            ...
            <View style={{ justifyContent: 'center' }}>
              <CheckBox
                onValueChange={(value) => this.Updet4(Object.id_dinner, Object.name_dinner_id, Object.name_dinner_chinese, Object.price_dinner, value, idx, status)}
                value={Object.value}
                checkedColor='red'
                tintColors={{ true: '#f5a21d', false: '#f5a21d' }}
              />
